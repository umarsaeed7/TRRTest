...
public class NumToEngContTest
{
    ...
    public void testContToEngDigNegNo()
    {
        // Convert -ve number 
        number = -12;
        strRes = "-ve " + TestCons.ENG_DIGS[(-1) * number];
        //Then
    ...
    {
        assertEquals(TestCons.ENG_DIGS_TENS[0] + " " + TestCons.ENG_DIGS[1], noToEngCont.contToEng(21));
        assertEquals(TestCons.ENG_DIGS_TENS[0] + " " + TestCons.ENG_DIGS[2], noToEngCont.contToEng(22));
        assertEquals(TestCons.ENG_DIGS_TENS[0] + " " + TestCons.ENG_DIGS[3], noToEngCont.contToEng(23));
        assertEquals(TestCons.ENG_DIGS_TENS[0] + " " + TestCons.ENG_DIGS[4], noToEngCont.contToEng(24));
        assertEquals(TestCons.ENG_DIGS_TENS[0] + " " + TestCons.ENG_DIGS[5], noToEngCont.contToEng(25));
        assertEquals(TestCons.ENG_DIGS_TENS[0] + " " + TestCons.ENG_DIGS[6], noToEngCont.contToEng(26));
        assertEquals(TestCons.ENG_DIGS_TENS[0] + " " + TestCons.ENG_DIGS[7], noToEngCont.contToEng(27));
        assertEquals(TestCons.ENG_DIGS_TENS[0] + " " + TestCons.ENG_DIGS[8], noToEngCont.contToEng(28));
        assertEquals(TestCons.ENG_DIGS_TENS[0] + " " + TestCons.ENG_DIGS[9], noToEngCont.contToEng(29));
    }
    ...
    public void testContToEngDigTens10To90()
    {
        for (int i = 2; i < 10; i++)
        {
            assertEquals(TestCons.ENG_DIGS_TENS[i - 2], noToEngCont.contToEng(10 * i));
        }
    }
